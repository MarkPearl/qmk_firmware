 ...
 * `----------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LGUI-L2 |  '"  |   /  | Left | Right|                                       |  Up  | Down |   [  |   ]  | RGUI |
 *   `------------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[BASE] = KEYMAP(  
        ...
        LT(MDIA, KC_LGUI), KC_QUOT,  KC_SLASH,    KC_LEFT,  KC_RGHT,
...
[VIM] = KEYMAP(
       ...
       TG(VIM), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
	...
	// left thumb area
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, TG(VIM),  KC_TRNS,  KC_TRNS, KC_TRNS,
